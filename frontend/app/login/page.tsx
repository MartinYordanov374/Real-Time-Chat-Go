  ...
  return (
    <div className="flex items-center min-h-screen justify-center bg-gray-50">
      <div className="w-full max-w-md rounded-lg p-8 shadow-xl">
        ...
        <p className="text-center text-gray-400 text-sm font-semibold mb-4">Log in to continue your conversations.</p>
          ...
          <p className="text-gray-900 text-center mt-4"> Don't have an account? 
            <a className="
            text-blue-500
            font-bold
