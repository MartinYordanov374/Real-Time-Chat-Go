...
export default function ChatList({chats, onSelectChat, currentUsername, onSelectUser}) {
  ...
  return (
    <div className="justify-left w-[50%] bg-white text-gray-900">
      ...
      <div className='flex shadow-xs p-4'>
        <div className='flex flex-col size-12 rounded-full bg-blue-500 p-2 justify-center items-center text-white'>
      ...
      <div>
        {DisplayedUsers?.length > 0 ?
         DisplayedUsers.map((User) => (
          <div className='flex flex-col gap-2 p-4 hover:bg-gray-100 cursor-pointer' onClick={()=>onSelectUser(User)}>
            <div className='flex'>
        ...
        :
          ...
          <div className='flex justify-center'> You do not have contacts yet </div> : 
            DisplayedChats.map((Chat) => (
                <div className='flex flex-col gap-2 p-4 hover:bg-gray-100 cursor-pointer' onClick={() => {onSelectChat(Chat), onSelectUser(undefined)}} key={Chat.id}>
                <div className='flex'>
                  <div className=' flex size-12 rounded-full bg-blue-500 p-2 justify-center items-center text-white'>
